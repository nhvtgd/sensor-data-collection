...
public class DBException extends TException implements org.apache.thrift.TBase<DBException, DBException._Fields>, java.io.Serializable, Cloneable, Comparable<DBException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DBException");
  ...
  static {
    schemes.put(StandardScheme.class, new DBExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DBExceptionTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DBException.class, metaDataMap);
  }
   ...
   */
  public DBException(DBException other) {
  ...
  public DBException setError_code(int error_code) {
  ...
  public DBException setMessage(String message) {
  ...
  public DBException setDetails(String details) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DBException)
      return this.equals((DBException)that);
    return false;
  }

  public boolean equals(DBException that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DBException other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DBException(");
    boolean first = true;
  ...
  private static class DBExceptionStandardSchemeFactory implements SchemeFactory {
    public DBExceptionStandardScheme getScheme() {
      return new DBExceptionStandardScheme();
    }
  }

  private static class DBExceptionStandardScheme extends StandardScheme<DBException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DBException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DBException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DBExceptionTupleSchemeFactory implements SchemeFactory {
    public DBExceptionTupleScheme getScheme() {
      return new DBExceptionTupleScheme();
    }
  }

  private static class DBExceptionTupleScheme extends TupleScheme<DBException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DBException struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DBException struct) throws org.apache.thrift.TException {
